...
export class CarExpensesService {
  ...
  async create(userId: string, createDto: CreateCarExpenseDto) {
    // Verify the car belongs to the member
  ...
  async update(id: string, userId: string, updateDto: UpdateCarExpenseDto) {
    // Verify ownership
